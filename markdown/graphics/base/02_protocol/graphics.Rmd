...
## `r sec1`.`r sec2 <- sec2 + 1; sec2`. Taking control of axes


## `r sec1`.`r sec2 <- sec2 + 1; sec2`. Taking control of plotting data


## `r sec1`.`r sec2 <- sec2 + 1; sec2`. Taking control of labeling
