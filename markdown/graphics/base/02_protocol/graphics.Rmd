...
- ` seq() `: Creates a vector based on regular sequence of values
    ...
    - ` by `: The interval between elements of the sequence
        - ` 0.2 `: Elements of the sequence should increment by 0.2
