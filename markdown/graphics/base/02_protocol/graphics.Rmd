...
sec2 <- 0
```
## `r sec1`. Taking full control of base R graphics
...
sec3 <- 0
```
### `r sec1`.`r sec2`. Taking full control of scaling a single graph
...
sec3 <- sec3 + 1
```
#### `r sec1`.`r sec2`.`r sec3` Defining inner margins
...
sec3 <- sec3 + 1
```
#### `r sec1`.`r sec2`.`r sec3` Defining the limits of the plot region
